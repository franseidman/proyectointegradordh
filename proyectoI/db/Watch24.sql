...
INSERT INTO users(id, username, mail, contrasena, nacimiento, prefijo, telefono)
VALUES
(default, "lruizcoines", "lruiz@example.com", "lruiz123456", "2000-03-12", null, 1234567890),
(default, "fseidman", "fseidman@example.com", "fs123456", "2001-07-08", "45", 1876543210),
(default, "mpautasso", "mpautasso@example.com", "mpc123456", "2001-06-26", null, 1121739900),
(default, "pepeargento", "pepea@example.com", "pepe10", "1971-05-17", null, 1231115213),
(default, "LNorris4", "Lando4@example.com", "Landoexample", "1999-02-07", null, 1235485213);


INSERT INTO products(id, imagen, nombre, creacion, descripcion, user_id)
VALUES
(default, "r1.jpg", "Chopard Mille Miglia Chromo", null, "Lorem Ipsum", 1),
(default, "r2.jpg", "F.P. Journe Automatique Réserve", null, "Lorem Ipsum", 2),
(default, "r3.jpg", "Rolex Daytona", null, "Lorem Ipsum", 3),
(default, "r4.jpg", "Luminor Panerai", null, "Lorem Ipsum", 4),
(default, "r5.jpg", "Chopard Mille Miglia Chromo 2.0", null, "Lorem Ipsum", 1),
(default, "r6.jpg", "F.P. Journe Automatique Réserve 2.0", null, "Lorem Ipsum", 4),
(default, "r7.jpg", "Rolex Daytona 2.0", null, "Lorem Ipsum", 5),
(default, "r8.jpg", "Luminor Panerai 2.0", null, "Lorem Ipsum", 5),
(default, "r9.jpg", "Chopard Mille Miglia Chromo 3.0", null, "Lorem Ipsum", 1),
(default, "r10.jpg", "F.P. Journe Automatique Réserve 3.0", null, "Lorem Ipsum", 5);
